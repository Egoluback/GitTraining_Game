...
warrior1 = Warrior(name1, 100, Weapon("hero's weapon", 100, 100), Shield("hero's shield", 70, (10, 20)))
warrior2 = Warrior(name2, 100, Weapon("superhero's weapon", 100, 100), Shield("superhero's shield", 70, (10, 20)))
